...
const TABLE_ROWS = [
  ["Нефтегазовая корпорация",  "Energy",       "12", "3.4×", "✓ Активен", "#10B981"],
  ["Строительный холдинг",     "Construction", "8",  "2.1×", "✓ Активен", "#10B981"],
  ["Ретейл-сеть 500+ точек",  "Retail",       "5",  "2.8×", "✓ Активен", "#10B981"],
  ["Логистический оператор",   "Logistics",    "3",  "1.9×", "● Запуск",  "#A78BFA"],
  ["Финтех-платформа",         "Finance",      "7",  "4.2×", "✓ Активен", "#10B981"],
] as const;
