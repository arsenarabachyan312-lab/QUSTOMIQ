...
const PARAGRAPHS = [
  <>
    <span style={{ color: "#F5F7F6" }}>QUSTOM</span>
    <span style={{ color: "#10B981" }}>IQ</span>
    {" — новая компания, но не новые люди. Мы — инженеры, которые годами строили системы для крупного бизнеса: SFA-платформы, документооборот, интеграции на сотни тысяч операций в день."}
  </>,
